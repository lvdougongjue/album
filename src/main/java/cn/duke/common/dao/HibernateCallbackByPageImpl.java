...
public class HibernateCallbackByPageImpl implements HibernateCallback<Object> {
	...
	public HibernateCallbackByPageImpl(String queryString, int topNum, Object[] value) {
	 ...
	 * 
	 * @see
	 * org.springframework.orm.hibernate.HibernateCallback#doInHibernate(net
	 * .sf.hibernate.Session)
	 */
